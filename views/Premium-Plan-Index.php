...
<head>
    ...
    <link rel="stylesheet" href="../public/css/Premium-Plan-Style.css" />
</head>
<body>
    ...
    <section class="cards membership" id="membership">
        ...
        <div class="content">
            ...
            <div class="card" onclick="goToMealPlanPage()">
                <div class="icon">
                    <img src="/images/plan.jpeg" class="planimage">
                </div>
                <div class="info">
    ...
    <script src="../public/js/Premium-Plan-JavaScript.js"></script>
